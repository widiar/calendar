<template>
  ...
  >
    <div class="relative flex flex-col items-center">
      ...
      ></div>
      <h3
        class="mt-6 text-lg font-semibold tracking-wide text-slate-800 dark:text-slate-100 animate-pulse"
      >
        Memuat Kalender...
      </h3>
    </div>
  ...
  >
    ...
    <div class="flex items-center space-x-3">
      <div class="flex items-center justify-center p-2 cursor-pointer" @click="openSettings">
        <svg
          ...
          class="transition-colors duration-300 text-gray-800 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400"
        >
          <path
          ...
          <div
            ...
            :class="[
              ...
              event.startDate === day.dateString && event.title
                ...
                : '',
              event.endDate === day.dateString && event.title
                ? 'rounded-r-lg pr-2 pl-0 border-r mr-1 w-[calc(100%-4px)]'
                : '',
              event.startDate !== day.dateString && event.endDate !== day.dateString && event.title
                  ...
                  >
                    ...
                    >
                      <div class="flex-1 min-w-0">
                        ...
                        <div
                          class="text-xs opacity-80 flex flex-col gap-0.5 mt-1 text-slate-700 dark:text-slate-300"
                        >
                    ...
                    <div v-else class="flex flex-col gap-2">
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <button
                          @click="saveEditEvent"
                          :disabled="isActionLoading || !editingEventTitle.trim()"
                    ...
                    <div
                      v-if="isActionLoading && loadingEventId === event.id"
          ...
          <div class="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              >
                ...
                <DialogTitle
                  as="h3"
                  class="text-base font-bold text-slate-900 dark:text-slate-50 mb-2"
                >
                  Hapus Jadwal?
                </DialogTitle>
            ...
            >
              ...
              >
                ...
                <form @submit.prevent="saveEvent" class="mt-4 space-y-4">
                  ...
                  <!-- Buttons -->
                  <div
                    class="mt-6 flex justify-end gap-2 border-t border-slate-100 dark:border-slate-700 pt-4"
                  >
                    <button
                      type="button"
                      :disabled="isSaving"
...
const getBadgeForDate = (dateString: string) => {
  const activeEvents = getEventsForDate(dateString, true)
...
const { value: formType, errorMessage: typeError } = useField<'libur' | 'imple' | 'freeze'>(
  'eventType',
)
